...
def process_log_file(cur, filepath):
    ...
    dic_time_df = dict(zip(column_labels, time_data))
    time_df = pd.DataFrame.from_dict(dic_time_df) 
    ...
    user_df = user_df.rename(columns = {'userId': 'user_id', 'firstName': 'first_name', 'lastName': 'last_name', 'gender': 'gender', 'level': 'level'})
